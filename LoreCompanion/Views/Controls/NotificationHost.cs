...
namespace LoreCompanion.Views.Controls
{
    ...
    public class NotificationHost : ItemsControl
    {
        ...
        public static readonly DependencyProperty NotificationAlignmentProperty = DependencyProperty.Register(
            nameof(NotificationAlignment),
            typeof(NotificationAlignment),
            typeof(NotificationHost),
            new PropertyMetadata(NotificationAlignment.TopCenter, OnNotificationAlignmentChanged));
        ...
        public NotificationHost()
        {
            ...
            var service = IoC.Get<INotificationService>();
        ...
        {
            itemsPresenter.SetCurrentValue(SeparatingPanel.ReverseOrderProperty, true);
        ...
        {
            itemsPresenter.SetCurrentValue(SeparatingPanel.ReverseOrderProperty, false);
        ...
        private void UpdatePositioning()
        {
            if (_rootPanel is null ||
                _itemsPresenter is not { } itemsPresenter ||
                !Enum.IsDefined(NotificationAlignment))
            {
                return;
            }
