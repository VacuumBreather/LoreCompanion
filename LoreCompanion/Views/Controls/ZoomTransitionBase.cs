...
namespace LoreCompanion.Views.Controls
{
    ...
    public abstract class ZoomTransitionBase : TransitionBase
    {
        ...
        {
            ArgumentNullException.ThrowIfNull(effectSubject);

            if (!(effectSubject.GetNameScopeRoot().FindName(effectSubject.ScaleTransformName) is ScaleTransform
                      transform))
            {
                return null;
            }
        ...
        public override void Cancel<TSubject>(TSubject effectSubject)
        {
            ...
            effectSubject.SetCurrentValue(UIElement.OpacityProperty, 1.0);
            ...
            _scaleTransform.SetCurrentValue(ScaleTransform.ScaleXProperty, 1.0);
            _scaleTransform.SetCurrentValue(ScaleTransform.ScaleYProperty, 1.0);
