...
namespace LoreCompanion.Views.Controls
{
    ...
    public abstract class TransitionSubjectBase : ContentControl, ITransitionSubject
    {
        ...
        public static readonly DependencyProperty CascadingDelayProperty = DependencyProperty.RegisterAttached(
            DependencyPropertyNameHelper.GetName(nameof(CascadingDelayProperty)),
            typeof(TimeSpan),
        ...
        public static readonly DependencyProperty TransitionDelayProperty = DependencyProperty.Register(
        ...
        public static readonly DependencyProperty TransitionEffectProperty = DependencyProperty.Register(
        ...
        public static readonly RoutedEvent TransitionFinishedEvent = EventManager.RegisterRoutedEvent(
            DependencyPropertyNameHelper.GetRoutedEventName(nameof(TransitionFinishedEvent)),
        ...
        public void PerformTransition(bool includeAdditionalEffects = true)
        {
            ...
            _storyboard.Begin(this.GetNameScopeRoot(), true);
        }
