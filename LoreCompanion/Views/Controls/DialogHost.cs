...
namespace LoreCompanion.Views.Controls
{
    ...
    public class DialogHost : ContentControl
    {
        ...
        public static readonly DependencyProperty DialogContainerStyleProperty = DependencyProperty.Register(
            nameof(DialogContainerStyle),
            typeof(Style),
            typeof(DialogHost),
        ...
        {
            var dialogService = (IDialogService)IoC.GetInstance(typeof(IDialogService), null!);

            if (dialogService is not null)
            {
                DataContext = dialogService;
        ...
        private static void OnPrivateContentChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                // Move keyboard focus to the first focusable control (or default button) inside the dialog
