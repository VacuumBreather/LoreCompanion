...
{
    /// <summary>
    ///     Defines a transition effect for a <see cref="FrameworkElement"/> implementing <see cref="ITransitionSubject"/>
    ///     .
    /// </summary>
    public interface ITransition
    {
        ...
        /// <returns>The built transition effect timeline, or <see langword="null"/> if it could not be built.</returns>
        ...
        /// <remarks>When implemented this should set the appropriate values which represent the end state of the transition.</remarks>
        /// <typeparam name="TSubject">The type of the <see cref="ITransitionSubject"/>.</typeparam>
        /// <param name="effectSubject">The <see cref="ITransitionSubject"/> of the effect.</param>
