namespace LoreCompanion.ViewModels.Dialogs
{
    ...
    {
        /// <summary>The dialog returns no result.</summary>
        None = 0,

        /// <summary>The result value of the message box is OK (usually sent from a button labeled OK).</summary>
        Ok = 1,

        /// <summary>The result value of the message box is Cancel (usually sent from a button labeled Cancel).</summary>
        Cancel = 2,
